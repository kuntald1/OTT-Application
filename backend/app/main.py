...
def _on_startup():
    # Not a database trigger — see app/scheduler.py's module docstring
    # for why this is a lightweight in-process poller instead.
    start_scheduler()
...
app.include_router(ad_banners.router, prefix="/api")
app.include_router(admin_ad_banners.router, prefix="/api")
app.include_router(organiser_profile.router, prefix="/api")
app.include_router(admin_organiser_profile.router, prefix="/api")
app.include_router(admin_discovery_settings.router, prefix="/api")
app.include_router(admin_partners.router, prefix="/api")
