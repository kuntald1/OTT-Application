...
export default function MovixGenreAccordion({ onSelectGenre = () => {} }) {
  ...
  return (
    <section
      ...
      style={{ background: NAVY_DEEP, fontFamily: "'Geist', -apple-system, sans-serif" }}
    >
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{ background: `linear-gradient(180deg, ${genre.tint}66 0%, ${NAVY_DEEP}DD 65%, ${NAVY_DEEP} 100%)` }}
              />
...
function BrowseOverlay({ genre, onClose, onSelectTitle }) {
  ...
  return (
    <div
      ...
      style={{ background: NAVY_DEEP, animation: "movixSlideUp 420ms cubic-bezier(0.16,1,0.3,1)" }}
    >
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {content.grid.map((title) => (
            ...
            >
              ...
              <div className="absolute inset-0" style={{ background: `linear-gradient(180deg, transparent 40%, ${NAVY_DEEP}EE 100%)` }} />
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[65vh] min-h-[460px] w-full overflow-hidden sm:h-[78vh]">
        ...
        <div className="absolute inset-0" style={{ background: `linear-gradient(180deg, ${NAVY_DEEP}33 0%, ${NAVY_DEEP}CC 70%, ${NAVY_DEEP} 100%)` }} />
