...
export default function TheaterHero() {
  ...
  return (
    <section
      ...
      style={{ boxShadow: "0 24px 60px -16px rgba(0,0,0,0.75), 0 0 40px -6px rgba(212,175,55,0.18), inset 30px 0 30px -30px rgba(0,0,0,0.65), inset -30px 0 30px -30px rgba(0,0,0,0.65)" }}
    >
      <style>{`
        @keyframes fadeIn {
